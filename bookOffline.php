    ...
    <section id="doctors" class="doctors">
      ...
      <div class="container">
        ...
        <div class="row">
          ...
          <div class="col-lg-6">
          	<form action="appointmentHandler.php?doctorid=<?php echo $doctorid ?>&time=<?php echo $_GET['time'] ?>&type=0" method="post" role="form" class="php-email-form">
		            ...
		            <div class="col-md-8 form-group">
		              ...
		              <div class="validate"></div>
		              <br>
		              <a href="appointmentHandler.php?doctorid=<?php echo $doctorid ?>&time=<?php echo $_GET['time'] ?>"><button type="submit" name="login-submit" class="btn btn-success">
                  		Send OTP
                </button></a>
