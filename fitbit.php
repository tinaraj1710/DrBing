...
<head>
	...
	<script type="text/javascript">var param = window.location.hash.slice(1); window.location = "http://localhost:8080/Dr.Bing/storeFitbit.php?".concat(param);</script>
	<!-- Bootstrap -->
...
<!-- 
		<div class="col-md-3 bg-info">
			...
			<div class="form-group">
				...
				<input type="text" class="form-control" name="client_id" id="client_id"  placeholder="Enter Fitbit Client ID">
			</div>
