<?php
    ...
    $next_page = $page_no + 1;
    $adjacents = "2";
    $result_count = mysqli_query($conn, "SELECT COUNT(*) As total_records FROM appointments WHERE doctor_id='$doctor_id'");
    ...
    <section id="doctors" class="doctors">
      <div class="container">
        <?php 
            ...
            $sql1 = "SELECT * FROM appointments WHERE doctor_id = '$doctor_id'";
          ...
          <div class="col-lg-6">
            <div class="member d-flex align-items-start">
              <div class="member-info">
                <h4><?php echo $row1['PatientName']; ?></h4>
